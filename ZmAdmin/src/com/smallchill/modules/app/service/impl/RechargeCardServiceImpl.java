 ...
 */
@Service
public class RechargeCardServiceImpl extends BaseService<RechargeCard> implements RechargeCardService {
	...
	public Map<String, Object> findOne(Object id) {
		return Md.selectOne("shopcard.findOne", CMap.init().set("id", id), Map.class);
	}
