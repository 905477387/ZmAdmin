...
public class BladeConfig {
	...
	private static Map<String, SQLManager> sqlManagerPool = new ConcurrentHashMap<>();
	private static Map<String, JedisPool> jedisPool = new ConcurrentHashMap<>();
	private static Map<String, JedisCluster> jedisCluster = new ConcurrentHashMap<>();
