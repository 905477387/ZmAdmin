...
public class BladeController {
	...
	*/
	 ...
	 * @return ApiResult
	*/
	public ApiResult json(Object data) {
	 ...
	 * @return ApiResult
	*/
	public ApiResult json(Object data, String message) {
	 ...
	 * @return ApiResult
	*/
	public ApiResult json(Object data, String message, int code) {
	...
	*/
	public ApiResult success(String message) {
		return new ApiResult().addSuccess(message);
	}
	...
	*/
	public ApiResult error(String message) {
		return new ApiResult().addError(message);
	}
	...
	*/
	public ApiResult warn(String message) {
		return new ApiResult().addWarn(message);
	}
	...
	*/
	public ApiResult fail(String message) {
		return new ApiResult().addFail(message);
	}
	...
	*/
	 ...
	 * 返回文件
	*/
	public void makeFile(HttpServletResponse response, File file, String fileName) {
		FileMaker.init(getRequest(), response, file, fileName).start();
	}
