...
public class BaseService<M> implements IService<M>, ConstCurd {
	...
	public long saveAndSyncKey(Object model, String keyName) {
		Blade dao = getSqlMananger();
		return dao.saveAndSyncKey(model, keyName);
	}
	...
	public int[] updateBatchTemplateById(List<?> list) {
		Blade dao = getSqlMananger();
		return dao.updateBatchTemplateById(list);
	}
	...
	public boolean saveOrUpdateEveryCol(Object model) {
		Blade dao = getSqlMananger();
		return dao.saveOrUpdateEveryCol(model);
	}
