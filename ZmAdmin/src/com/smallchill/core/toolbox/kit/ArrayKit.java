...
public class ArrayKit {
	 ...
	 * @return 过滤后的数组
	 */
	public static <T> T[] filter(T[] array, IEditor<T> editor) {
	...
	public static <T> String join(T[] array, String conjunction) {
		...
		for (T item : array) {
			...
			if(ArrayKit.isArray(item)) {
				sb.append(join(ArrayKit.wrap(item), conjunction));
			} else if(item instanceof Iterable<?>) {
				sb.append(CollectionKit.join((Iterable<?>)item, conjunction));
			} else if(item instanceof Iterator<?>) {
				sb.append(CollectionKit.join((Iterator<?>)item, conjunction));
			} else{
				sb.append(item);
			}
		}
