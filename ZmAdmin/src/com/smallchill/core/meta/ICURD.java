...
public interface ICURD {
	 ...
	 * @param ac
	 */
	ApiResult saveSucceed(AopContext ac);
	 ...
	 * @param ac
	 */
	ApiResult updateSucceed(AopContext ac);
	 ...
	 * @param ac
	 */
	ApiResult removeSucceed(AopContext ac);
	 ...
	 * @param ac
	 */
	ApiResult delSucceed(AopContext ac);
	 ...
	 * @param ac
	 */
	ApiResult restoreSucceed(AopContext ac);
}
