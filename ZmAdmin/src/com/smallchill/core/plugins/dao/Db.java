...
public class Db {
	...
	*/
	 ...
	 * @return
	 */
	public static Long queryLong(String sqlTemplate, Object paras){
		return getDbManager().queryLong(sqlTemplate, paras);
	}
	 ...
	 * @return
	 */
	public static List<Long> queryListLong(String sqlTemplate, Object paras){
		return getDbManager().queryListLong(sqlTemplate, paras);
	}
