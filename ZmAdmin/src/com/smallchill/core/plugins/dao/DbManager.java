...
public class DbManager {
	...
	*/
	 ...
	 * @return
	 */
	public Long queryLong(String sqlTemplate, Object paras){
		List<Long> list = getSqlManager().execute(sqlTemplate, Long.class, paras);
		if(list.size() == 0){
			return -1L;
		} else {
			return list.get(0);
	 ...
	 * @return
	 */
	public List<Long> queryListLong(String sqlTemplate, Object paras){
		List<Long> list = getSqlManager().execute(sqlTemplate, Long.class, paras);
		return list;
	}
